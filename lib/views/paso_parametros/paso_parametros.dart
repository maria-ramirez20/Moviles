...
class PasoParametros extends StatefulWidget {
  const PasoParametros({super.key});

  @override
  State<PasoParametros> createState() => PasoParametrosScreenState();
}

class PasoParametrosScreenState extends State<PasoParametros> {
