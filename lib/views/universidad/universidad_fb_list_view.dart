...
class UniversidadFbListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<UniversidadesFb>>(
...
class _CategoriaCard extends StatelessWidget {
  final UniversidadesFb categoria;
  final int index;
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 13,
                  color: categoria.direccion.isEmpty
                      ? colorScheme.onSurfaceVariant.withValues(alpha: 0.5)
                      : colorScheme.onSurfaceVariant,
                  fontStyle: categoria.direccion.isEmpty
                      ? FontStyle.italic
                      : FontStyle.normal,
                ),
                maxLines: 2,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (categoria.direccion.isNotEmpty) ...[
                    const SizedBox(height: 4),
                    Text(
                      categoria.direccion,
                      style: TextStyle(
